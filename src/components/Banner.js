    ...
    <>
      ...
      <div className="container mx-auto">
        ...
        <div className="flex justify-around">
          <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg dark:bg-white dark:border-gray-700 m-10 shadow-lg">
            <a href="/">
              <img
          ...
          <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
              <a href="/" class="flex items-center">
                ...
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-yellow-400">
                  MenWell CO.
                </span>
              </a>
            </div>
